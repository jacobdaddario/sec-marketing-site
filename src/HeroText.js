...
const HeroText = () => (
  <div className="flex flex-col items-center max-w-2xl mx-auto px-4 pt-6 xl:pt-16 2xl:pt-20 2xl:mr-40">
    <img src={secLogoWhite} alt="white SEC logo" className="h-48 2xl:h-56" />
    <h2 className="text-center text-white text-2xl leading-snug tracking-tight font-semibold xl:text-3xl xl:leading-tight 2xl:text-3xl">
      Welcome to the SEC,
      <br />
